...
class PhysicalMyWindow: public PhysicalOperator
{
public:
    PhysicalMyWindow(const std::string& logicalName,
...
DECLARE_PHYSICAL_OPERATOR_FACTORY(PhysicalMyWindow, "mywindow", "myWindow")
