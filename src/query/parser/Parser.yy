...
%token<keyword>     CICULAR/*my keyword test*/
%token<keyword>     WHERE
...
window_noise:
      VARIABLE                                           {$$ = _fac.newBoolean(@$,true);std::cout<<"got variable"<<std::endl;}
    | CICULAR						 {$$ = _fac.newBoolean(@$,true);std::cout<<"got variable"<<std::endl;}
